...
export type InviteFeed = ChatFeed<KnownFeedType.INVITE> &
  FeedFragment.Inviter &
  FeedFragment.MemberList;
...
export type OpenJoinFeed = ChatFeed<KnownFeedType.OPENLINK_JOIN> &
  FeedFragment.MemberList;
...
export type OpenKickFeed = ChatFeed<KnownFeedType.OPENLINK_KICKED> &
  FeedFragment.Member;
export type OpenHandOverHostFeed =
  ChatFeed<KnownFeedType.OPENLINK_HAND_OVER_HOST> & FeedFragment.OpenHandOver;

export type OpenManagerGrantFeed = ChatFeed<KnownFeedType.OPEN_MANAGER_GRANT> &
  FeedFragment.Member;
export type OpenManagerRevokeFeed =
  ChatFeed<KnownFeedType.OPEN_MANAGER_REVOKE> & FeedFragment.Member;

export type ChannelDeletedFeed = ChatFeed<KnownFeedType.CHANNEL_DELETED>;
export type DeleteAllFeed = ChatFeed<KnownFeedType.DELETE_TO_ALL> &
  FeedFragment.Message;

export type OpenLinkFeeds =
  | OpenJoinFeed
  | OpenLinkDeletedFeed
  | OpenRewriteFeed
  | OpenKickFeed
